...
def rescale_betas_to_original(betas, scaler):
    """Convert standardized-coefficient betas back to original feature scale."""
...
def run_model_for_product(df, product_name, target_var, all_vars, mandatory_vars, 
    ...
    try:
        ...
        betas = rescale_betas_to_original(betas, scaler)
...
def main():
    ...
    if uploaded_file is not None:
        ...
        if run_all_products and st.session_state.all_products_results is not None:
            ...
            betas_full = rescale_betas_to_original(betas_full, scaler)
            ...
            if run_dual_model and partial_idx is not None:
                ...
                betas_partial = rescale_betas_to_original(betas_partial, scaler)
